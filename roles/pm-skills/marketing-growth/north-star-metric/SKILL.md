...
description: "Use when choosing a North Star Metric, setting up a metrics framework, learning about the North Star Framework, or deciding what to measure."
---
# North Star Metric
...
Sean Ellis (North Star Framework), April Dunford (Obviously Awesome). Adapted from [phuryn/pm-skills](https://github.com/phuryn/pm-skills) (MIT), re-authored for pi.
