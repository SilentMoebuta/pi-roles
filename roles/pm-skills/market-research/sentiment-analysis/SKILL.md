...
description: "Use when analyzing user feedback at scale, running sentiment analysis on reviews or surveys, or identifying satisfaction patterns."
---
...
Rob Fitzpatrick (The Mom Test), Steve Portigal (Interviewing Users). Adapted from [phuryn/pm-skills](https://github.com/phuryn/pm-skills) (MIT), re-authored for pi.
