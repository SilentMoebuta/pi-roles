---
name: gtm-motions
description: "Use when selecting marketing channels, choosing between inbound and outbound strategy, or planning cross-channel campaigns."
---
# GTM Motions
...
Maja Voje (GTM), Geoffrey Moore (Crossing the Chasm). Adapted from [phuryn/pm-skills](https://github.com/phuryn/pm-skills) (MIT), re-authored for pi.
