...
description: "Use when creating a value proposition, analyzing customer value delivery, or articulating why customers should choose your product."
---
# Value Proposition
...
Roger Martin (Playing to Win), Michael Porter (Competitive Strategy), Ash Maurya (Running Lean), Strategyzer/Osterwalder (BMC, Value Proposition Design). Adapted from [phuryn/pm-skills](https://github.com/phuryn/pm-skills) (MIT), re-authored for pi.
